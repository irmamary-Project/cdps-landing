    ...
    <>
      <Header>
        ...
        <div className="flex items-center gap-4 sm:gap-6">
          ...
          <Link href="/#pricing" className="text-sm text-gray-500 hover:text-primary font-medium transition-colors">
            Harga
          </Link>
          <Link href="/demo" className="bg-accent hover:bg-accent-dark text-primary text-sm font-bold px-5 py-2 rounded-full transition-all hover:shadow-lg hover:shadow-accent/30">
            Coba Demo
          </Link>
        </div>
      </Header>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-5 gap-10 lg:gap-16">
              <div className="lg:col-span-2">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:cdps@lumizo.my.id" className="text-sm text-primary hover:underline">
                        cdps@lumizo.my.id
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-xl bg-[#FEF9E7] flex items-center justify-center flex-shrink-0">
                      <Icon name="whatsapp" size={18} className="text-accent" />
                    </div>
                    <div>
                      <p className="text-sm font-semibold text-gray-900">WhatsApp</p>
                      <a href="https://wa.me/6289656059612" target="_blank" rel="noopener noreferrer" className="text-sm text-primary hover:underline">
                        0896-5605-9612
                      </a>
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-xl bg-[#E6F9FA] flex items-center justify-center flex-shrink-0">
                      <Icon name="sekolah" size={18} className="text-secondary" />
                    </div>
                    <div>
                ...
                <div className="mt-10 p-6 bg-gradient-to-br from-primary-pale to-white rounded-2xl border border-primary-pale">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 bg-secondary hover:bg-[#03A0A8] text-white font-bold px-6 py-3 rounded-full text-sm transition-all"
                  >
                  ...
                  {sent ? (
                    <div className="text-center py-16">
                      <div className="w-16 h-16 rounded-full bg-primary-pale flex items-center justify-center mx-auto mb-4">
                        <Icon name="checklist" size={24} className="text-secondary" />
                      </div>
                      ...
                      <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all resize-none"
